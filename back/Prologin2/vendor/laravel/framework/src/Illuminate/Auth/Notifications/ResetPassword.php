...
class ResetPassword extends Notification
{
    ...
    protected function resetUrl($notifiable)
    {
        ...
        return url("http://localhost:3000/reset?token={$this->token}&email={$notifiable->getEmailForPasswordReset()}");
        // return url("http://localhost:3000/?token={$this->token}&email={$notifiable->getEmailForPasswordReset()}&redirect=reset");
    }
