...
class LikeController extends Controller
{
    ...
    // public function Wlike(Request $request)
    // {
    //     $likeDislikeCounts = DB::table('LikeAndDislike')
    //         ->select('WID', DB::raw('SUM(GiveLike) as total_likes'), DB::raw('SUM(GiveDislike) as total_dislikes'))
    //         ->groupBy('WID')
    //         ->get()
    //         ->toArray();

    //     return response()->json(["like_dislike_counts" => $likeDislikeCounts]);
    // }
